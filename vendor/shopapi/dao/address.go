...
func (self *Address) InsertTx(tx *dbr.Tx) (int64,error)  {
	...
	result,err :=tx.InsertInto("address").Columns("name","mobile","app_id","open_id","longitude","latitude","address","weight","flag","json").Record(self).Exec()
	if err!=nil{
...
func (self *Address) Insert() (int64,error)  {
	...
	result,err :=db.NewSession().InsertInto("address").Columns("name","mobile","app_id","open_id","longitude","latitude","address","weight","flag","json").Record(self).Exec()
	if err!=nil{
